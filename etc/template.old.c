...
//litterally jsut to trick vscode to think we have the Headers
// NOTE make sure in c_cpp_properties.json its set to CLANG and not GCC so the intelisence gets trickerd
#ifdef __clang__
